...
export default function ReturningVisitor({ data }) {
  return (
    <div className="flex flex-col items-center">
      <div className="relative flex items-center justify-center bg-yellow-200 border-2 border-black rounded-full w-15 h-15 shadow-md">
        {/* Left Handle */}
        <Handle
          type="target"
        ...
        {/* Icon */}
        <RefreshCcw size={24} color="black" strokeWidth={2} />
      </div>
